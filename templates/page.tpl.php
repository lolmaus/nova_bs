...
<div id="page">
  ...
  <?php if ($page['header']): ?>
    <header id="header-wrapper"><div id="header-wrapper-inner">
      <div id="header" role="banner" class="container">
        <?php print render($page['header']); ?>
      </div> <!-- /#header -->
    </div></header><!-- /#header-wrapper-inner /#header-wrapper -->
  <?php endif; ?>

  <?php if ($page['subheader']): ?>
    <nav id="subheader-wrapper">
      <div class="container">
  ...
  <div id="main-wrapper"><div id="main" class="container" role="main">
