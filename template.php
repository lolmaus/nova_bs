...
/**
 * @file
 * Contains theme override functions and preprocess functions for the nova_bs theme.
 */

/**
 * Changes the default meta content-type tag to the shorter HTML5 version
 */
function nova_bs_html_head_alter(&$head_elements) {
 ...
 */
function nova_bs_preprocess_search_block_form(&$vars) {
 ...
 */
function nova_bs_preprocess_html(&$vars) {
 ...
 */
function nova_bs_breadcrumb($vars) {
